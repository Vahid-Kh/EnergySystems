...
def COP(T_amb_C):
    ...
    S9 = [h_gc_out_1, P_gc_1, 'GC1_out']
    S10 = [h_suction_booster, P_gc_1, 'Booster_suction']
    S11 = [h_discharge_booster, P_gc_2, 'Booster_discharge']
    S12 = [h_gc_out_2, P_gc_2, 'GC2_out']
    S13 = [h_in_rec, P_rec, 'Rec_in']
    S14 = [h_out_vbv, P_evap_MT, 'VBV_out']
    s15 = [h_mix_1, P_evap_MT, 'Mix1']
    S16 = [h_mix_2, P_evap_MT, 'Mix2']
    S17 = [h_suction_MT, P_evap_MT, 'MT_suction']
    S18 = [h_discharge_MT, P_gc_1, 'MT_discharge']
    S19 = [h_suction_booster, P_gc_1, 'Booster_suction']
    S20 = [h_discharge_booster, P_gc_2, 'Booster_discharge']
    S21 = [h_gc_out_2, P_gc_2, 'GC2_out']
    # Print Booster cooling contribiution


    # print(COP, [S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, s15, S16, S17, S18, S19, S20, S21])
    return COP, [S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, s15, S16, S17, S18, S19, S20, S21]

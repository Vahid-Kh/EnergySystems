...
tdn700 = TDN(70000000, 0, 300,0, 0, Media)

# print(tdn700.propl())
tdn20 = TDN(2000000, tdn700.h, 0,0, 0, Media)
# print(tdn20.cp())
# print(tdn20.propl())
tdn3= TDN(300000,tdn20.h,0,0,0, Media)
# print(tdn3.propl())
# print(tdn3.cp())

# print("Cooled down at 20 bar")
tdn20cool = tdn20 = TDN(2000000, 0, 300,0, 0, Media)
tdn3= TDN(300000,tdn20cool.h,0,0,0, Media)
# print(tdn3.propl())
# print(tdn3.cp())
...
# print(p_out)
tdn_in = TDN(p_in, 0, t_in, 0, 0, Media)
tdn_out_isen = TDN(p_out, 0, 0, tdn_in.s, 0, Media)
print("Density difference " , tdn_in.d, tdn_out_isen.d)
print(tdn_in.h, (TDN(p_in, 0, 0, tdn_in.s, 0, Media)).h)
# print((tdn_in.h - (TDN(p_in , 0, 0, tdn_in.s, 0, "Hydrogen")).h) / 0.8)
# print("This is a test: ", tdn_in.h, tdn_out_isen)
tdn_out_real = TDN(p_out, (tdn_in.h + (-tdn_in.h + (TDN(p_out, 0, 0, tdn_in.s, 0, Media)).h) / eta_comp), 0, 0, 0, Media)
# print("p_in  "  ,p_in,"   |  p_out   ",p_out)
...
print("p_in="  ,p_in/1e5, "|  p_out=",p_out/1e5, " | heat",(((tdn_out_real.t - t_in) * tdn_out_real.cp())/1e6)," | Elec=", (((tdn_out_real.t - t_in) * tdn_out_real.cp()*(1/(1-eta_comp)) )/1e6), "| Eta_Isen = ", eta_comp)
...
print(tdn_out_real.cp())
tdn8 = TDN(800000,0,300,0,0, Media)
